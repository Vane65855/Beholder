...
**Current checkpoint:** Phase 9.1 (Scanner foundation — `lan_device` schema + `SqliteLanDeviceStore` + `OuiVendorLookup` + `Beholder.Tools.OuiFetcher` console tool. ADR 009 scopes Scanner = LAN device discovery; sub-phases 9.2–9.6 ship the probe, scanner, RPCs, UI, and Traffic-tab cross-link)
**Test count:** 919
