...
**Current checkpoint:** Phase 8 + polish (Traffic → Map sub-view — world heatmap with top-3 destinations per country in the hover tooltip; extended `GetProcessDestinations` RPC with optional country filter + limit)
**Test count:** 890
